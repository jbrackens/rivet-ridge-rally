...
export const EDITOR_MODULES: readonly EditorModuleDefinition[] = [
  ...
  { id: "barrier-short", name: "Short Barrier", category: "hazards", length: 8, laneSpan: 1, difficulty: 2, description: "Change lanes, or wheelie across with heavy speed loss." },
  { id: "barrier-offset", name: "Offset Barriers", category: "hazards", length: 26, laneSpan: 2, difficulty: 3, description: "Readable slalom; wheelie contact costs speed." },
