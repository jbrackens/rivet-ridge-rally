...
The current non-QA local `dist/` served on `127.0.0.1:4173` contains 33 files totaling 7,993,780 raw bytes. `index.html` is 1,632 bytes with SHA-256 `d0798a1948f3841309abf5ba7b8f32a5d416ca11e33eb8a4ae9eddcc8bda4115`; `assets/3d/hero-bike-rider.glb` is 511,736 bytes with SHA-256 `5537ba34639053a1b28b40978853ceade33f9d3ac40d2d2c477e59ce206c024a`; the inventory aggregate is `f34bc89e76b7322370a00bf99ff1071814651c0ad0608d57a1f1140035b56f12`; and the 43,872-byte notices have SHA-256 `f837ed705667d0f3976bbd419f42d8c63844a3eb4b52f76db88ed3a1d6e270c2`. A live HTTP sanity check confirmed preview PID 53866 serves the rebuilt `assets/index-D6qXQbL8.js`, `assets/index-C2e4audF.css`, `assets/GameView-BmN9DcbP.js`, `assets/TrackEditorScreen-CTwXuvGB.js`, and `assets/CoursePresentationRoute-BPxp5CMT.js` bytes. This is a local dirty-tree checkpoint, not a format-2 manifest, installed/offline production smoke, immutable artifact, or release qualification.
...
Release-provenance hardening is implemented in source and remains **UNVERIFIED** as a real candidate gate. The guard captures clean `HEAD`, creates its detached checkout, validates the exact annotated tag, npm package tree, Node identity, clean inputs, and isolated output, and fails closed on unsafe/special entries or mutation. Current `npm run test:release-manifest` passes 45/45; historical format-1 evidence remains unchanged. A real `npm run visual:candidate` attempt on 2026-07-18 correctly exited 1 with `Release guard failed: Git working tree is not clean`, and a later clean-branch attempt exposed and corrected an overbroad binary token-prefix false positive. The latest clean `13c01173d991c1b18b32c32f1032d10b075a4c34` source produced visual QA candidate aggregate `b7d7f6cf302f2ebb5806f6575e2d31b54bf333016d69bf57c7d8dbbfae30a878`, candidate manifest SHA-256 `789acdc82f6cbcb9fa9342ec716b9e003b21d0522760ff9f8d671d2723d7a4d9`, and `artifacts/visual-review/rc2-five-track-controlled-13c0117/manifest.json` records 11/11 `PASS` with SHA-256 `3506b9aa90d02d50329f80a2f783f1da99a7c40a81f7ebc67166670ef8f2fa9c`.
...
Latest visual-candidate rehearsal: `npm run visual:candidate` was attempted on 2026-07-18 and failed before writing candidate bytes because the working tree was not clean. A later clean-branch attempt reached the isolated `dist/` scan and exposed an overbroad `ghp_` byte-prefix check against the binary Canyon GLB. The follow-up `npm run test:release-manifest` passed 45/45 after adding the short-token-prefix regression. The latest clean `13c0117` `visual:candidate` produced a 33-file / 7,997,693-byte visual QA candidate with aggregate `b7d7f6cf302f2ebb5806f6575e2d31b54bf333016d69bf57c7d8dbbfae30a878`; `visual:capture` wrote `artifacts/visual-review/rc2-five-track-controlled-13c0117/manifest.json`, passed 11/11, and recorded manifest SHA-256 `3506b9aa90d02d50329f80a2f783f1da99a7c40a81f7ebc67166670ef8f2fa9c`. The correct next action is owner/legal visual review plus guarded baseline promotion, not another blind capture retry.
