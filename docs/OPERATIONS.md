...
The current non-QA local `dist/` served on `127.0.0.1:4173` contains 33 files totaling 7,993,481 raw bytes. `index.html` is 1,632 bytes with SHA-256 `3c0e0512a2de9069eda1c24d997fc2bd8bcee68026cc79ecc3f6e7287b69917c`; `assets/3d/hero-bike-rider.glb` is 511,736 bytes with SHA-256 `5537ba34639053a1b28b40978853ceade33f9d3ac40d2d2c477e59ce206c024a`; the inventory aggregate is `a7b7fce8391efc0e9ed9da5362f4e7e360ca7a28a2b74ce993c634e818231312`; and the 43,872-byte notices have SHA-256 `f837ed705667d0f3976bbd419f42d8c63844a3eb4b52f76db88ed3a1d6e270c2`. A live HTTP sanity check confirmed preview PID 53866 serves the rebuilt `assets/index-D5P8qhTo.js`, `assets/index-C2e4audF.css`, `assets/GameView-DHUUCsDP.js`, `assets/TrackEditorScreen-CZ943VjK.js`, and `assets/CoursePresentationRoute-2fyenR2t.js` bytes. This is a local dirty-tree checkpoint, not a format-2 manifest, installed/offline production smoke, immutable artifact, or release qualification.
