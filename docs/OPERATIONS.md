...
The current non-QA local `dist/` served on `127.0.0.1:4173` contains 33 files totaling 7,993,481 raw bytes. `index.html` is 1,632 bytes with SHA-256 `b7256caab1b2b6da1dc5f09f466fcccbd624d534ce1fe14d40f37cd2554aa164`; `assets/3d/hero-bike-rider.glb` is 511,736 bytes with SHA-256 `5537ba34639053a1b28b40978853ceade33f9d3ac40d2d2c477e59ce206c024a`; the inventory aggregate is `acf804a2e0e607462e0becbd11e7ffac28c3014fd7c10578bf1812bd8945f140`; and the 43,872-byte notices have SHA-256 `f837ed705667d0f3976bbd419f42d8c63844a3eb4b52f76db88ed3a1d6e270c2`. A live HTTP sanity check confirmed preview PID 53866 serves the rebuilt `assets/index-DCOSK6EY.js`, `assets/index-C2e4audF.css`, `assets/GameView-DQe7ao7K.js`, `assets/TrackEditorScreen-Dfnik0Tv.js`, and `assets/CoursePresentationRoute-DJKpPI7B.js` bytes. This is a local dirty-tree checkpoint, not a format-2 manifest, installed/offline production smoke, immutable artifact, or release qualification.
...
Current focused tutorial/gameplay paths pass the intended raised-front-wheel barrier clear with speed cost and the slower heat journey, and working-tree unit/integration coverage passes. Source-level complete-field Rookie/Rider/Ace AI calibration also passes across all five launch tracks. Production-length representative-player tuning, physical/manual fairness, frozen-candidate repetition, and manual collision/visual review remain **UNVERIFIED**.
