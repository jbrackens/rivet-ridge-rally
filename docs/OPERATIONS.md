...
The current non-QA local `dist/` served on `127.0.0.1:4173` contains 33 files totaling 7,993,780 raw bytes. `index.html` is 1,632 bytes with SHA-256 `2b3547f4a8ce922329a21792b856a7fdf68b1a0004e6d61c74a08a0d5119c34d`; `assets/3d/hero-bike-rider.glb` is 511,736 bytes with SHA-256 `5537ba34639053a1b28b40978853ceade33f9d3ac40d2d2c477e59ce206c024a`; the inventory aggregate is `b5de862273f681f75f71ed80e226ff9b1f110c516fe4716f2f4fdc669854c3bb`; and the 43,872-byte notices have SHA-256 `f837ed705667d0f3976bbd419f42d8c63844a3eb4b52f76db88ed3a1d6e270c2`. A live HTTP sanity check confirmed preview PID 53866 serves the rebuilt `assets/index-D0D7ZK0W.js`, `assets/index-C2e4audF.css`, `assets/GameView-C3rbHpEi.js`, `assets/TrackEditorScreen-UEXBw8zt.js`, and `assets/CoursePresentationRoute-BmKpVSGz.js` bytes. This is a local dirty-tree checkpoint, not a format-2 manifest, installed/offline production smoke, immutable artifact, or release qualification.

The current headed diagnostic at `artifacts/candidate-evidence/diagnostic/performance/current-0049739-headed-rebuilt-20260719T060319Z.json` reports clean source/runtime binding to `0049739`, stable served bytes, authored hero readiness, and no request, HTTP, console, or page errors. Desktop normal/stress measured 60.00/60.01 FPS with 2.8/3.1 ms p95 synchronous frame work; emulated-mobile normal/stress measured 60.00/60.00 FPS with 3.7/4.4 ms p95. Its overall status is `FAIL` only because the required format-2 release manifest does not exist yet. It is diagnostic evidence, not schema-4 release performance qualification or physical-device proof.
