...
The current non-QA local `dist/` served on `127.0.0.1:4173` contains 33 files totaling 7,993,481 raw bytes. `index.html` is 1,632 bytes with SHA-256 `889ff36aa47336ef512fbefe90c7ca894afb2bc829f3bbad4feaf753aa56c79e`; `assets/3d/hero-bike-rider.glb` is 511,736 bytes with SHA-256 `5537ba34639053a1b28b40978853ceade33f9d3ac40d2d2c477e59ce206c024a`; the inventory aggregate is `a1028c2ab3828fc3cba391ce525cdb00942f2216e776a7008079c6cf725b5024`; and the 43,872-byte notices have SHA-256 `f837ed705667d0f3976bbd419f42d8c63844a3eb4b52f76db88ed3a1d6e270c2`. A live HTTP sanity check confirmed preview PID 53866 serves the rebuilt `assets/index-FFE4fPVX.js`, `assets/index-C2e4audF.css`, `assets/GameView-DybCyky1.js`, `assets/TrackEditorScreen-CSwrCVee.js`, and `assets/CoursePresentationRoute-CyZOHre-.js` bytes. This is a local dirty-tree checkpoint, not a format-2 manifest, installed/offline production smoke, immutable artifact, or release qualification.
