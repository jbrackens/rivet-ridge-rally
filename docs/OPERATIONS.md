...
The current non-QA local `dist/` served on `127.0.0.1:4173` contains 33 files totaling 7,999,709 raw bytes. `index.html` is 1,632 bytes with SHA-256 `5defb554d609880da737e32ba7a30ea653623e80858f8b1d842864f463387196`; `assets/3d/hero-bike-rider.glb` is 517,664 bytes with SHA-256 `538be4269927544fa91cfc405742523a60422d77d546ce9c8859f407deb2e6e8`; the inventory aggregate is `b801ba05c10acfbf164d6eedcfeef13a2d5008c408f538f4d5d41c6ca7209c9d`; and the 43,872-byte notices have SHA-256 `f837ed705667d0f3976bbd419f42d8c63844a3eb4b52f76db88ed3a1d6e270c2`. A live HTTP sanity check confirmed preview PID 53866 serves the rebuilt `assets/index-DLME50so.js`, `assets/index-C2e4audF.css`, `assets/GameView-C8kib3ol.js`, `assets/TrackEditorScreen-CndPG8nY.js`, and `assets/CoursePresentationRoute-VH_04Tdm.js` bytes. A later current-head non-QA Rider School smoke at `/tmp/rrr-live-smoke/current-head-rider-school-36fec40.json` and `/tmp/rrr-live-smoke/current-head-rider-school-36fec40-1280x720.png` proved runtime commit `36fec40b3d9ac5084861dd9592acfa6de3165227` with `dirty=false`, absent QA API, authored hero/Canyon/environment readiness, the 49,780 / 39,912 / 9,868 / 14,284 hero triangle split, PMREM/contact-shadow/dust diagnostics, Start Lesson 1 interaction, tutorial forward progress from `0.0` to `0.8`, and no page/request/HTTP/unexpected-console failures; only known browser `ReadPixels` and title-preload warnings were recorded. This is a local working-tree checkpoint, not a format-2 manifest, installed/offline production smoke, immutable artifact, or release qualification.
...
Release-provenance hardening is implemented in source and remains **UNVERIFIED** as a real candidate gate. The guard captures clean `HEAD`, creates its detached checkout, validates the exact annotated tag, npm package tree, Node identity, clean inputs, and isolated output, and fails closed on unsafe/special entries or mutation. Current `npm run test:release-manifest` passes 45/45; historical format-1 evidence remains unchanged. A real `npm run visual:candidate` attempt on 2026-07-18 correctly exited 1 with `Release guard failed: Git working tree is not clean`, and a later clean-branch attempt exposed and corrected an overbroad binary token-prefix false positive. The latest clean `8882c332671a476ff3a14e9777aa367f8bb9a6ca` source produced visual QA candidate aggregate `5fadbb3d5b3108ca0c33759a7af3881db1c5767a584cd7cfc1a8c191eb1b32e0`, candidate manifest SHA-256 `c6b600228c6f314ddeb1571f72288be689ab33f6fb389ef4e8a513ccfd8c1087`, and `artifacts/visual-review/rc2-five-track-controlled-8882c33/manifest.json` records 11/11 `PASS` with SHA-256 `054f3b983dd242baf461c68f640489754616e3ae2a9d9746d5c0e7e2f1390c09`.
...
Latest visual-candidate rehearsal: `npm run visual:candidate` was attempted on 2026-07-18 and failed before writing candidate bytes because the working tree was not clean. A later clean-branch attempt reached the isolated `dist/` scan and exposed an overbroad `ghp_` byte-prefix check against the binary Canyon GLB. The follow-up `npm run test:release-manifest` passed 45/45 after adding the short-token-prefix regression. The latest clean `8882c33` `visual:candidate` produced a 33-file / 8,003,622-byte visual QA candidate with aggregate `5fadbb3d5b3108ca0c33759a7af3881db1c5767a584cd7cfc1a8c191eb1b32e0`; `visual:capture` wrote `artifacts/visual-review/rc2-five-track-controlled-8882c33/manifest.json`, passed 11/11, and recorded manifest SHA-256 `054f3b983dd242baf461c68f640489754616e3ae2a9d9746d5c0e7e2f1390c09`. The correct next action is owner/legal visual review plus guarded baseline promotion, not another blind capture retry.
