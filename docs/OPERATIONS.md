...
Release-provenance hardening is implemented in source and remains **UNVERIFIED** as a real candidate gate. The guard captures clean `HEAD`, creates its detached checkout, validates the exact annotated tag, npm package tree, Node identity, clean inputs, and isolated output, and fails closed on unsafe/special entries or mutation. Current `npm run test:release-manifest` passes 45/45; historical format-1 evidence remains unchanged. A real `npm run visual:candidate` attempt on 2026-07-18 correctly exited 1 with `Release guard failed: Git working tree is not clean`, and a later clean-branch attempt exposed and corrected an overbroad binary token-prefix false positive. The latest clean `16e49d4ed0b4db183e656766a8a2ac66aa7bc72a` source produced visual QA candidate aggregate `27ee5c23a35ab99f3113c37b8707f59a6cd3d504f8b5847597ed913f149f0a10`, candidate manifest SHA-256 `c9366913e1d1feaa935482dd36d88c8fbecae5e7082ab96d34c2b45467d01772`, and `artifacts/visual-review/rc2-five-track-controlled-16e49d4/manifest.json` records 11/11 `PASS` with SHA-256 `58b655efd7130a6e0e21b20f81f1c908baf2440db85bdb67ed3f8ce92de7e45d`.
...
Latest visual-candidate rehearsal: `npm run visual:candidate` was attempted on 2026-07-18 and failed before writing candidate bytes because the working tree was not clean. A later clean-branch attempt reached the isolated `dist/` scan and exposed an overbroad `ghp_` byte-prefix check against the binary Canyon GLB. The follow-up `npm run test:release-manifest` passed 45/45 after adding the short-token-prefix regression. The latest clean `16e49d4` `visual:candidate` produced a 33-file / 8,003,622-byte visual QA candidate with aggregate `27ee5c23a35ab99f3113c37b8707f59a6cd3d504f8b5847597ed913f149f0a10`; `visual:capture` wrote `artifacts/visual-review/rc2-five-track-controlled-16e49d4/manifest.json`, passed 11/11, and recorded manifest SHA-256 `58b655efd7130a6e0e21b20f81f1c908baf2440db85bdb67ed3f8ce92de7e45d`. The correct next action is owner/legal visual review plus guarded baseline promotion, not another blind capture retry.
