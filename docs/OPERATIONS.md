...
The current non-QA local `dist/` served on `127.0.0.1:4173` contains 33 files totaling 7,999,709 raw bytes. `index.html` is 1,632 bytes with SHA-256 `737fb0b42dc502e139225cc3af1c69c306b8a472544176867d214257b13beb15`; `assets/3d/hero-bike-rider.glb` is 517,664 bytes with SHA-256 `538be4269927544fa91cfc405742523a60422d77d546ce9c8859f407deb2e6e8`; the inventory aggregate is `98130df16f3dfdfd58aa1c3bf843da2849c49d31ae01e9ac3acdf5217ae56fc1`; and the 43,872-byte notices have SHA-256 `f837ed705667d0f3976bbd419f42d8c63844a3eb4b52f76db88ed3a1d6e270c2`. A live HTTP sanity check confirmed preview PID 53866 serves the rebuilt `assets/index-DvNpByZL.js`, `assets/index-C2e4audF.css`, `assets/GameView-B9wcyrGQ.js`, `assets/TrackEditorScreen-C2SxphUB.js`, and `assets/CoursePresentationRoute-DdSg06-i.js` bytes. This is a local dirty-tree checkpoint, not a format-2 manifest, installed/offline production smoke, immutable artifact, or release qualification.
